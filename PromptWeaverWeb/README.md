...
- GitHub Pages で公開しているのは静的な Web アプリです
- プロジェクトデータはサーバーではなくブラウザの `localStorage` に保存されます
- QR コードはアプリ内で生成しており、共有 URL を外部の QR 生成サービスへ送っていません
- リポジトリ運用の確認項目は [../SECURITY_CHECKLIST.md](../SECURITY_CHECKLIST.md) にまとめています
